...
If you don't have the permission to do this, set [limitOpenFilesOnRemote](https://github.com/neuraorganization/neurasync/wiki/Configuration#limitopenfilesonremote) option in your config.
