...
You can change the default behavior by [syncOption](https://github.com/neuraorganization/neurasync/wiki/Configuration#syncoption).
...
*Only [skipCreate](https://github.com/neuraorganization/neurasync/wiki/Configuration#syncoptionskipcreate) and [ignoreExisting](https://github.com/neuraorganization/neurasync/wiki/Configuration#syncoptionignoreexisting) are valid for this command.*
